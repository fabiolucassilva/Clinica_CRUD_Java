                ...
                <div class="row align-items-start">
                  <div class="col">
                    <div class="info-user">
                        ...
                        <h1 style="margin-top: 35px; margin-bottom:-15px;">Cadastrar Especialidades:</h1>
                        ...
                        <div class="container">
                            <div class="row align-items-start">
                              <div class="col">
                                <div class="info-user">
                                    <h3 style="margin-top: 35px; margin-bottom:15px;">Lista de Tipos de Especialidades:</h3>
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <tbody>
                                              <%
                                                  for(int i = 0; i < ListaEspecialidades.size() ; i++){
                                                      Especialidade esp = ListaEspecialidades.get(i);
                                              %>
                                              <tr>
                                                <th scope="row"> <%out.print(esp.getId());%> </th>
                                                <td> <%out.print(esp.getDesc());%></td>
                                              </tr>
                                              <%
                                                }
                                              %>
                                      ...
                                      <%    
                                        ...
                                        <div class="alert alert-primary" role="alert">
                                            Não existe nenhuma especialidade cadastrada.
                                        </div>
                                      <%}%>
                        ...
                        <div class="container">
                            <div class="row align-items-start">
                              <div class="col">
                                <div class="info-user">
                                    <h3 style="margin-top: 35px; margin-bottom:15px;">Inserir nova Especialidade:</h3>
                        ...
                        <div class="container">
                            <div class="row align-items-start">
                              <div class="col">
                                <div class="info-user">
                                    <h3 style="margin-top: 35px; margin-bottom:15px;">Editar Especialidade:</h3>

                                    <form action="" method="POST" class="formulario">
                                        <div class="mb-3">
                                            <label for="funcao" class="form-label">Escolha a Especialidade a ser Editado*</label>
                                            <select class="form-select" name="IdMedico" aria-label="Default select example" required>
                                                ...
                                                if(ListaEspecialidades.size()>0){
                                                  ...
                                                  for(int i = 0; i < ListaEspecialidades.size() ; i++){
                                                      Especialidade esp = ListaEspecialidades.get(i);
                                                %>
                                                <option value="<%out.print(esp.getId());%>">ID <%out.print(esp.getId());%> (<%out.print(esp.getDesc());%>)</option>
                                                    <%}
                                                }%>
                        ...
                        <div class="container">
                            <div class="row align-items-start">
                              <div class="col">
                                <div class="info-user">
                                    <h3 style="margin-top: 35px; margin-bottom:15px;">Excluir Especialidade:</h3>

                                    <form action="" method="POST" class="formulario">
                                        <div class="mb-3">
                                            <label for="funcao" class="form-label">Escolha a Especialidade*</label>
                                            <select class="form-select" name="IdMedico" aria-label="Default select example" required>
                                                <option selected disabled value="">Escolha uma opção</option>
                                                <%
                                                if(ListaEspecialidades.size()>0){
