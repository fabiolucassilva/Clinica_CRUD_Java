                            ...
                            <div class="row align-items-start">
                              <div class="col">
                                <div class="info-user">
                                    ...
                                    <h3 style="margin-top: 35px; margin-bottom:15px;">Todas as consultas do(a) médico(a)  ID<%out.println(medico.getId());%> - <%out.println(medico.getNome());%> ( <%out.println(medico.getCpf());%>):</h3>
